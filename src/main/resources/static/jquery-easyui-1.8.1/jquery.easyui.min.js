...
_363(_371,_372);
opts.onAdd.call(_371,_372.title,_372.login);
if(_372.selected){
_374(_371,_372.login);
}
};
...
var _844=_83d(_842,_843.login!=undefined?_843.login:_843.id);
...
view.insertRow.call(view,_85f,_860.login,_860.row);
_861.push(_860.row);
...
var row=opts.finder.getRow(_866,_867.login);
var _869=false;
_867.row=_867.row||{};
...
opts.view.updateRow.call(opts.view,_866,_867.login,_867.row);
}
};
function _86b(_86c){
...
var tr=opts.finder.getTr(_884,(_885.login!=undefined?_885.login:_885.id),_885.type);
if(!tr.length){
return;
}
